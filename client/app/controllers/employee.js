        ...
        link: function(scope, ele, attrs) {
          d3Service.d3().then(function(d3) {
            ...
            var findFirstMonth = function(item, year) {
              ...
              return months.indexOf(item.startDate.month);
            };
            ...
            var buildItems = function(general, lanes){
              ...
              general.forEach(function(item){
                ...
                newItem.id = item.title;
                newItem.category = item.title;
                newItem.class = 'past ' + item.title;
            ...
            var buildLanes = function(general) {
              var categories = getKeysInArray(general, 'title');
              var lanes = [];
              var id = 0;
